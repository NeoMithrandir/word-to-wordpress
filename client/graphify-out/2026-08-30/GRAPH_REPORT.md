# Graph Report - client  (2026-08-29)

## Corpus Check
- 15 files · ~8,774 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 147 nodes · 194 edges · 12 communities (11 shown, 1 thin omitted)
...
2. `Vite Migration - Final Steps` - 10 edges
3. `PublishSettings()` - 8 edges
...
- `PublishSettings()` --calls--> `resolvePublishSites()`  [EXTRACTED]
  src/components/PublishSettings.tsx → src/config/wordpress.config.ts
...
### Community 0 - "App.tsx"
Cohesion: 0.13
Nodes (21): App(), AppPage, Citation, DeployStatus, Equation, Footnote, ProcessedContent, ProcessedImage (+13 more)
...
Cohesion: 0.17
Nodes (18): DeployResult, PostSettings, PublishOutcome, deployLabel(), DESTINATION_OPTIONS, destinationLabel(), publishButtonLabel(), PublishSettings() (+10 more)
...
## Knowledge Gaps
- **75 isolated node(s):** `name`, `version`, `private`, `type`, `axios` (+70 more)
