# Graph Report - word-to-wordpress  (2026-08-29)

## Corpus Check
- 45 files · ~28,115 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 519 nodes · 680 edges · 32 communities (24 shown, 8 thin omitted)
...
- `ProcessedContentOverlay` --references--> `ProcessedContent`  [EXTRACTED]
  src/services/ProcessedContentCache.ts → src/services/DocumentProcessor.ts
...
Cohesion: 0.08
Nodes (40): App(), AppPage, Citation, Equation, Footnote, PostSettings, ProcessedContent, ProcessedImage (+32 more)

### Community 1 - "Community 1"
Cohesion: 0.11
Nodes (18): BibliographyEntry, Citation, Equation, Footnote, ProcessedContent, ProcessedImage, NOTE: We intentionally do NOT use the Word paragraph style "Footnote Text", convertToWebp() (+10 more)
...
Cohesion: 0.08
Nodes (30): AppError, createError(), errorHandler(), app, documentProcessor, jsonBodyLimitMb, limiter, localSaveService (+22 more)
...
## Knowledge Gaps
- **243 isolated node(s):** `axios`, `config`, `name`, `version`, `private` (+238 more)
...
- **Why does `DocumentProcessor` connect `Community 5` to `Community 1`, `Community 10`, `Community 12`?**
